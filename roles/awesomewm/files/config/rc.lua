...
-- The remapping is idempotent - safe to run multiple times
awful.spawn.once("setxkbmap -option caps:none")
awful.spawn.once("xmodmap -e 'keycode 66 = F13'")
...
beautiful.init(gears.filesystem.get_configuration_dir() .. "themes/catppuccin-mocha/theme.lua")

-- Load cell management system
local cell_management = require("cell-management")
...
globalkeys = gears.table.join(
  ...
  end, { description = "screenshot full screen to clipboard", group = "screenshot" }),
...
awful.rules.rules = {
  ...
  -- Disable titlebars (use borders for focus indication)
  {
...
-- Add cell-management auto-positioning rules
