...
wt.help() {
  ...
  print -r -- "  herd [task|context|issue|done]"
  print -r -- "                     Create a Worktrunk checkout and a no-focus"
  print -r -- "                     Herdr tab in the current workspace. Does not"
  print -r -- "                     start an agent; run herd --help for the grammar."
  print -r -- ""
  print -r -- "Examples:"
